jQuery(document).ready(function ($) {
    $('.dexp-gmap-shortcode').each(function () {
        ...
        var iconBase = 'https://www.tazur.com/sites/default/files/';
